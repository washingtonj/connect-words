...
export default function Result() {
  ...
  const { attempts, combinations, time } = JSON.parse(atob(queryData || '') || '{}')
  ...
  return queryData ? (
    <div className="h-screen flex flex-col items-center justify-center px-8 lg:w-4/12 lg:m-auto">
      ...
      <p>Você teve <b>{percentage}%</b> de aproveitamento, conseguindo ligar todas as palavras em <b>{time}</b> minutos com <b>{attempts} tentativas.</b></p>
      <span className="mt-4">
